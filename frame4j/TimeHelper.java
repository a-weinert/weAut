 ...
 *   {@link de.frame4j.time.TimeHelper de.frame4j.time.TimeHelper}</b>
 ...
 *  {@code java TimeHelper "1.1.1890 12:10 CET"\}<br />
 *  instead of<br /> &nbsp; &nbsp;
 *  {@code java de.frame4j.time.TimeHelper "1.1.1890 12:10 CET"}<br />
 *  for example.<br />
 *  <br />
...
public final class TimeHelper {
   ...
   private TimeHelper(){} // no objects; no javaDoc 

/** Start forwarder for TimeHelper. <br />
 *  <br />
 *  Delegation to  {@link de.frame4j.time.TimeHelper}.<br />
 *  <br />
 *  @param  args command line parameter<br />
 *  @see de.frame4j.Update#main(String[])
 */
   public static void main(String[] args){
      de.frame4j.time.TimeHelper.main(args);
   } // main(String[])
