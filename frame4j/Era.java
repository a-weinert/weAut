...
/** <b>Convenience starter of {@link de.frame4j.Era}</b>
 ...
 *  {@code java Era -v -q &#0064;listFileOfToBeDel.txt}<br />
 *  instead of<br /> &nbsp; &nbsp;
 *  {@code java de.frame4j.Era -v -q &#0064;listFileOfToBeDel.txt}<br />
 *  for example.<br />
 *  <br />
...
public final class Era {
   ...
   private Era(){} // no objects; no javaDoc 

/** Start forwarder for Era . <br />
 *  <br />
 *  Delegation to  {@link de.frame4j.Era}.<br />
 *  <br />
 *  @param  args command line parameter<br />
 *  @see de.frame4j.Era#main(String[])
 */
   public static void main(String[] args){
      de.frame4j.Era.main(args);
   } // main(String[])
