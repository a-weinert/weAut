...
/** <b>Convenience starter of {@link de.frame4j.SVNkeysFilter}</b>
 ...
 *  {@code java SVNkeysFilter . -omitDirs CVS;doc-files;.svn}<br />
 *  instead of<br /> &nbsp; &nbsp;
 *  {@code java de.frame4j.SVNkeysFilter . -omitDirs CVS;doc-files;.svn}<br />
 *  for example.<br />
 *  <br />
...
public final class SVNkeysFilter {
   
   private SVNkeysFilter(){} // no objects; no javaDoc 

/** Start forwarder for SVNkeysFilter. <br />
 *  <br />
 *  Delegation to  {@link de.frame4j.SVNkeysFilter}.<br />
 *  <br />
 *  @param  args command line parameter<br />
 *  @see de.frame4j.SVNkeysFilter#main(String[])
 */
   public static void main(String[] args){
      de.frame4j.SVNkeysFilter.main(args);
   } // main(String[])
