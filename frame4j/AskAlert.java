...
/** <b>Convenience starter of {@link de.frame4j.AskAlert} </b>
 ...
 *  {@code java AskAlert -pause "JavaDoc generated" "All OK (# of warnings ?)"}<br />
 *  instead of<br /> &nbsp; &nbsp;
 *  {@code java de.frame4j.AskAlert -pause "JavaDoc generated" "All OK (# of warnings ?)"}<br />
 *  for example.<br />
 *  <br />
...
public final class AskAlert {
   ...
   private AskAlert(){} // no objects; no javaDoc 

/** Start forwarder for AskAlert. <br />
 *  <br />
